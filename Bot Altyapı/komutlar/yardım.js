...
//YARDIM KOMUTU
  ...
  **[${prefix}yardım Genel](https://discord.gg/CKyasCWCZQ)** 
  **[${prefix}yardım Eğlence](https://discord.gg/CKyasCWCZQ)**
  **[${prefix}yardım Moderasyon](https://discord.gg/CKyasCWCZQ)**
  **[${prefix}yardım Sunucu](https://discord.gg/CKyasCWCZQ)**
  **[${prefix}yardım Abone](https://discord.gg/CKyasCWCZQ)**
  **[${prefix}yardım Logo](https://discord.gg/CKyasCWCZQ)**
  **[${prefix}yardım Yedek](https://discord.gg/CKyasCWCZQ)**
  **[${prefix}yardım Kullanıcı](https://discord.gg/CKyasCWCZQ)**
  **[${prefix}yardım Bot](https://discord.gg/CKyasCWCZQ)**
  **[${prefix}yardım kayıt](https://discord.gg/CKyasCWCZQ)**
  **[${prefix}yardım Ticket](https://discord.gg/CKyasCWCZQ)**
  **[${prefix}yardım Sahip](https://discord.gg/CKyasCWCZQ)**
  `)
  .addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=818567252004962404&scope=bot&permissions=2108157183)` + "** | **" + `[Destek Sunucusu](https://discord.gg/CKyasCWCZQ)`  + "" + ``  + "** | **" + `[Web Sitesi](http://dark-angel.ml/)  `, false)
